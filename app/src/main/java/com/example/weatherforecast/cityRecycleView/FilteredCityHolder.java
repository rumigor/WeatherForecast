...
public class FilteredCityHolder extends RecyclerView.ViewHolder {
    private final TextView cityName;
    private final TextView lastTemp;
    private final TextView lastDate;


    public FilteredCityHolder(@NonNull View itemView) {
        super(itemView);
    ...
    void bind(final Story cities, final FilteredCityAdapter.OnCityClickListener onCityClickListener) {
